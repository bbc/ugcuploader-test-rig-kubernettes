...
eksctl create iamserviceaccount --name ugcupload-control --namespace control  --cluster ugcloadtest --attach-policy-arn $POLICY_ARN --approve --override-existing-serviceaccounts
